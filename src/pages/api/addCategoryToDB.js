...
/*
* Cet handler permet de récupérer les informations entrées par l'administrateur sur une catégorie qu'il souhaite ajouter.
*
...
export default async function handler(req, res) {
    ...
    // Sinon, on ajoute la catégorie dans la BDD et on renvoie un message pour signaler qu'il n'y a pas eu de problème.
